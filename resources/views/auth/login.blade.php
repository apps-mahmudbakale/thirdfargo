...
<head>
    <base  />
    <title>Login | Fargo Remit Bank</title>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1" />
    <meta name="robots" content="index, follow">
    <meta name="apple-mobile-web-app-title" content="Fargo Remit Bank" />
    <meta name="application-name" content="Fargo Remit Bank" />
    ...
    <link href="../assets/admin/vendor/fontawesome-free/css/all.min.html" rel="stylesheet" type="text/css">
    <!-- lineawesome font -->
...
<!-- header end -->    <div class="main-wrapper">


    <section class="account-section bg_img" style="background-image: url('../assets/images/frontend/login_bg/6110c9ec14e281628490220.html');">
        <div class="account-section-left">
            <div class="account-section-left-inner">
                <h4 class="title text-white mb-2">Welcome to Fargo Remit Bank</h4>
                <p class="text-white">Please input your username and password and login into your account</p>

                <!-- <p class="mt-xl-5 mt-3 text-white">Haven't an account? <a href="#" class="text--base">Contact Customer Service</a></p> -->
            </div>
        </div>
        <div class="account-section-right">
            ...
            <div class="middle">
                ...
                <form action="" class="user" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <input type="password" name="password" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Enter your password...">
                    </div>
...
<!-- Javascript-->
<script src="assets/admin/vendor/jquery/jquery.min.html"></script>
<scriptIO type="text/javascript" src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></scriptIO <script src="../assets/admin/vendor/bootstrap/js/bootstrap.bundle.html">
</script>
