...
<head>
    ...
    <title>BankCo - Transaction</title>
    ...
    <div class="w-full flex relative">
        ...
        >
            ...
            >
                ...
                <div class="upgrade-wrapper w-full h-[172px] pr-[24px] mb-[26px]">
                    <div
                        class="w-full h-full rounded-lg upgrade-banner relative"
                  ...
                  <span>
                    ...
                    >
                      ...
                      />
                        ...
                        <p
                            class="text-sm leading-5 text-white opacity-[0.5] text-center px-7 mb-2"
                        >
                ...
                <div class="copy-write-text">
                    ...
                    <p class="text-sm text-bgray-700 font-medium">
                        ...
                        <a
                            href="#"
                            target="_blank"
                            class="font-semibold border-b hover:text-blue-600"
                        >QuomodoTheme</a
                        >
                    </p>
                </div>
        ...
        <aside class="sm:block hidden relative w-[96px] bg-white dark:bg-black">
            <div class="w-full sidebar-wrapper-collapse relative top-0 z-30">
                ...
                >
                    <a href="index.html">
                        <img src="./assets/images/logo/logo-short.svg" class="dark:hidden block" alt="logo" />
                        <img src="./assets/images/logo/logo-short-white.svg" class="hidden dark:block" alt="logo" />
                    </a>
                </div>
        ...
        <div class="body-wrapper dark:bg-darkblack-500 flex-1 overflow-x-hidden">
                  ...
                  >
                    ...
                    <div class="quick-access-wrapper relative">
                      ...
                      >
                                ...
                                >
                      <span
                          class="w-3.5 h-3.5 rounded-full bg-error-300 border-2 border-white absolute -right-[5px] -top-[2px] dark:border-none"
                      ></span>
                                    <svg
                                ...
                                >
                      <span
                          class="w-3.5 h-3.5 rounded-full bg-bgray-300 border-2 border-white absolute -right-[5px] -top-[2px] dark:bg-bgray-600 dark:border-none "
                      ></span>
                                    <svg
                                        class="stroke-bgray-900 dark:stroke-white"
                                        width="24"
                            ...
                            <div
                                class="xl:block hidden h-[48px] w-[1px] bg-bgray-300 dark:bg-darkblack-400"
                            ></div>
                            <!--                author-->
                            <div
                            ...
                            >
                                <div
                                    class="w-[52px] h-[52px] rounded-xl border border-bgray-300 overflow-hidden"
                                >
                                    <img
                                        class="object-cover"
                        ...
                        <div class="notification-popup-wrapper">
                            <div
                                onclick="notificationAction()"
                                id="noti-outside"
                                class="w-full h-full fixed -left-[43px] top-0 hidden"
                            ></div>
                            <div
                                id="notification-box"
                                style="
                    ...
                    "
                          ...
                          >
                            ...
                            />
                                    ...
                                    <ul
                                        class="w-full h-[335px] overflow-y-scroll scroll-style-1"
                                    >
                                        <li
                                        ...
                                        >
                                            <a href="#">
                                                <div class="noti-item">
                                                    ...
                                                    >
                                                        <strong class="text-bgray-900 dark:text-bgray-50"
                                                        >James Eusobio</strong
                                                        >
                                                        send a new payment for
                                                        <strong class="text-bgray-900 dark:text-bgray-50"
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                <span>All</span>
                                                <span
                                                    class=" w-5 h-5 bg-success-50 inline-flex justify-center items-center text-success-300 rounded-full text-[10px]"
                                                >2</span
                                                >
                                            </button>
                                        </div>
                                            ...
                                            >
                                                <a href="#">
                                                    <div class="flex space-x-3">
                                                        <div
                                                            class="w-[48px] h-[48px] rounded-full relative"
                                                        >
                                                            <img
                                            ...
                                            >
                                                <a href="#">
                                                    <div class="flex space-x-3">
                                                        ...
                                                        <div class="flex-1">
                                                            <p
                                                                class="font-bold text-base text-bgray-900 mb-1"
                                                            >
                                                                Eusobio Joy
                                                            </p>
                    ...
                    "
                            ...
                            >
                                <div class="w-full p-6 relative">
                                    <div
                                        class="bonus-box-wrapper overflow-hidden w-full pb-[33px]"
                                    >
                                        <div
                                            class="bonus-box w-full flex justify-center relative"
                                        >
                                            <div
                                            ...
                                            ></div>
                                            <div
                                                class="w-full p-5 bg-success-300 rounded-lg relative"
                                            >
                                                <h3
                                                    class="text-[28px] text-white font-bold text-center"
                                                >
                                                    60% Bonus
                                                </h3>
                                                <p
                                                ...
                                                <div class="flex justify-center">
                                                    <a href="#">
                                                        ...
                                                        >
                                  <span class="text-bgray-900 text-sm font-bold"
                                  >Discover More</span
                                  >
                                                        </div>
                                                    </a>
                              ...
                              "
                                    ...
                                    <p
                                        class="text-sm font-semibold text-success-300 text-center mb-2.5"
                                    >
                                        Discover more
                                    </p>
                                    <div class="flex justify-center">
            ...
            <header class="md:hidden block mobile-wrapper w-full fixed z-20">
                <div
                    class="w-full h-[80px] bg-white dark:bg-darkblack-600 flex justify-between items-center"
                >
                    ...
                    <div class="mr-2">
                        ...
                        >
                            ...
                            <div class="2xl:block hidden">
                                <div class="flex space-x-2.5 items-center">
                                    <h3
                                        class="text-base text-bgray-900 font-bold leading-[28px]"
                                    >
                                        John Doe
                                    </h3>
                                    <span>
                        ...
                        <div class="w-full py-[20px] px-[24px] rounded-lg bg-white dark:bg-darkblack-600">
                            <div class="flex flex-col space-y-5">
                                <div class="w-full flex h-[56px] space-x-4">
                                    <div
                                        class="lg:w-88 sm:w-70 sm:block hidden border border-transparent focus-within:border-success-300 h-full bg-bgray-100 dark:bg-darkblack-500 rounded-lg px-[18px]"
                                    >
                                        <div
                              ...
                              />
                                            ...
                                            <label for="listSearch" class="w-full">
                                                <input
                                                    ...
                                                    class="search-input w-full bg-bgray-100 border-none px-0 focus:outline-none focus:ring-0 text-sm placeholder:text-sm text-bgray-600 tracking-wide placeholder:font-medium placeholder:text-bgray-500 dark:bg-darkblack-500 dark:text-white"
                                                />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="flex-1 h-full relative">
                                        <button
                                            ...
                                            type="button"
                                            class="w-full h-full flex justify-center items-center bg-bgray-100 dark:bg-darkblack-500 dark:border-darkblack-500 border border-bgray-300 rounded-lg"
                                        >
                            ...
                            <span>
                                        ...
                                        <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                            <td class="">
                                                <label class="text-center">
                                                    <input
                                                        type="checkbox"
                                                        class="focus:outline-none focus:ring-0 rounded-full border border-bgray-400 cursor-pointer w-5 h-5 text-success-300 dark:bg-darkblack-600 dark:border-darkblack-400"
                                                    />
                                                </label>
                                            </td>
                                            <td
                                ...
                                >
                                  ...
                                  />
                                            ...
                                            <td class="py-5 px-6 xl:px-0">
                                                <div class="flex space-x-2.5 items-center">
                              <span
                                  class="text-base font-medium text-bgray-600 dark:text-gray-50"
                              >
                                Location</span
                              >
                                                    <span>
                              ...
                              >
                                        ...
                                        <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                            ...
                                            <td class="py-5 px-6 xl:px-0">
                                                <div class="w-full flex space-x-2.5 items-center">
                                                    ...
                                                    >
                                                        <img
                                                            src="./assets/images/avatar/user-40x40-3.png"
                                                            alt="avatar"
                                                            class="w-full h-full object-cover"
                                                        />
                                                    </div>
                                        ...
                                        <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                            ...
                                            <td class="py-5 px-6 xl:px-0">
                                                <div class="w-full flex space-x-2.5 items-center">
                                                    ...
                                                    >
                                                        <img
                                                            src="./assets/images/avatar/user-40x40-4.png"
                                                            alt="avatar"
                                                            class="w-full h-full object-cover"
                                                        />
                                                    </div>
                                        ...
                                        <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                            ...
                                            <td class="py-5 px-6 xl:px-0">
                                                <div class="w-full flex space-x-2.5 items-center">
                                                    ...
                                                    >
                                                        <img
                                                            src="./assets/images/avatar/user-40x40-6.png"
                                                            alt="avatar"
                                                            class="w-full h-full object-cover"
                                                        />
                                                    </div>
                                ...
                                <div class="pagination-content w-full">
                                    <div
                                        class="w-full flex lg:justify-between justify-center items-center"
                                    >
                                        <div class="lg:flex hidden space-x-4 items-center">
                          <span class="text-bgray-600 dark:text-bgray-50 text-sm font-semibold"
                          >Show result:</span
                          >
                                            <div class="relative">
                                                <button
                                                ...
                                                >
                              <span class="text-sm font-semibold text-bgray-900 dark:text-bgray-50"
                              >3</span
                              >
                                                    <span>
                                <svg
                                ...
                                >
                                  ...
                                  />
                                        ...
                                        <div
                                            class="flex sm:space-x-[35px] space-x-5 items-center"
                                        >
                                            <button type="button">
                            <span>
                              <svg
                                ...
                                <div class="flex flex-col space-y-[32px] mb-5">
                                    <div class="flex justify-start">
                                        <div class="flex space-x-3 items-end">
                                            <div class="flex space-x-2 items-center">
                                                <div
                                                    class="w-[36px] h-[35px] rounded-full overflow-hidden"
                                                >
                                                    <img
                                            ...
                                            <span class="text-bgray-500 text-xs font-medium"
                                            >10:00 PM</span
                                            >
                                        </div>
                                    </div>
